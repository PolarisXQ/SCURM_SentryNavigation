...
Please check the "Global Options - Fixed Frame" field in the RViz "Display" pannel. Set the field value to "lidar_link" and check the "PointCloud2" option in the pannel.
