...
#ifndef NAV2_VELOCITY_SMOOTHER_EXT__VELOCITY_SMOOTHER_HPP_
#define NAV2_VELOCITY_SMOOTHER_EXT__VELOCITY_SMOOTHER_HPP_
...
/**
 * @class velocity_smoother_ext::VelocitySmootherExt
 * @brief This class that smooths cmd_vel velocities for robot bases
 */
class VelocitySmootherExt : public nav2_util::LifecycleNode
{
public:
  /**
   * @brief A constructor for velocity_smoother_ext::VelocitySmootherExt
   * @param options Additional options to control creation of the node.
   */
  explicit VelocitySmootherExt(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());

  /**
   * @brief Destructor for velocity_smoother_ext::VelocitySmootherExt
   */
  ~VelocitySmootherExt();
...
protected:
  ...
  /**
   * @brief Callback for incoming speed up commands
   * @param msg Float32 message
   */
  void speedUpCallback(const std_msgs::msg::Float32::SharedPtr msg);
  ...
  rclcpp::Subscription<std_msgs::msg::Float32>::SharedPtr speed_up_sub_;
